...
describe('UsersService', () => {
  ...
  describe('register', () => {
    it('should register a new user', async () => {
      ...
      mockUserRepository.findOne.mockResolvedValue(undefined); // Email not taken
    ...
    it('should throw ConflictException if email is already in use', async () => {
      ...
      mockUserRepository.findOne.mockResolvedValue({ id: 1, email: 'existing@example.com' }); // Email taken
